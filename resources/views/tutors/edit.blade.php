            ...
            <x-card title="Data Diri Tutor">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="sm:col-span-2">
                        <x-input label="Nama Lengkap" name="name" :value="old('name', $tutor->name)"
                            placeholder="Nama tutor" :error="$errors->first('name')" />
                    </div>
                    <x-input label="No. Telepon" name="telp" :value="old('telp', $tutor->telp)"
                        placeholder="08xxxxxxxxxx" :error="$errors->first('telp')" />
                    <x-input label="Tanggal Lahir" name="dob" type="date"
                        :value="old('dob', $tutor->dob?->format('Y-m-d'))"
                        :error="$errors->first('dob')" />
                    <div class="sm:col-span-2">
                        <x-input label="Domisili" name="domicille" :value="old('domicille', $tutor->domicille)"
