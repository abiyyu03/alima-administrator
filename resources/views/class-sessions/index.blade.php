            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div class="divide-y divide-gray-50">
                    ...
                    <div class="flex items-center justify-between px-4 py-3 hover:bg-gray-50">
                        ...
                        <form method="POST" action="{{ route('class-sessions.destroy', $session) }}" class="shrink-0 ml-3"
                              onsubmit="return confirm('Hapus sesi ini?')">
                            @csrf @method('DELETE')
                            <input type="hidden" name="week" value="{{ $weekStart->format('Y-m-d') }}">
                            <button type="submit" class="p-1.5 rounded-lg text-gray-400 hover:bg-red-50 hover:text-red-500 transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
