        ...
        <div class="grid grid-cols-1 lg:grid-cols-1 gap-6">
            <x-card title="Data Kelas">
                <div class="space-y-4">
                    ...
                    <x-select label="Jenis Kursus" name="course_type_id" :error="$errors->first('course_type_id')" x-model="courseTypeId"
        ...
        <script>
            function classForm() {
                ...
                return {
                    ...
                    get isPrivate() {
                        return privateTypes.includes(parseInt(this.courseTypeId));
                    },
